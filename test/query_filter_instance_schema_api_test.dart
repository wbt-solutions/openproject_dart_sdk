...
/// tests for QueryFilterInstanceSchemaApi
void main() {
  var instance = QueryFilterInstanceSchemaApi();

  group('tests for QueryFilterInstanceSchemaApi', () {
    ...
    test('test apiV3ProjectsIdQueriesFilterInstanceSchemasGet', () async {
      // TODO
    });
    ...
    test('test apiV3QueriesFilterInstanceSchemasGet', () async {
      // TODO
    });
    ...
    test('test apiV3QueriesFilterInstanceSchemasIdentifierGet', () async {
      // TODO
    });
