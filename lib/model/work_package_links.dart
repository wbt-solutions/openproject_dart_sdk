...
class WorkPackageLinks {
  ...
  static WorkPackageLinks? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "WorkPackageLinks[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "WorkPackageLinks[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return WorkPackageLinks(
        ...
        ancestors: Link.listFromJson(json[r'ancestors']) ?? const [],
  ...
  static List<WorkPackageLinks>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <WorkPackageLinks>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = WorkPackageLinks.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, WorkPackageLinks> mapFromJson(dynamic json) {
    final map = <String, WorkPackageLinks>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = WorkPackageLinks.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<WorkPackageLinks>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<WorkPackageLinks>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = WorkPackageLinks.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
