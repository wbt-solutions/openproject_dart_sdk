...
// tests for PrincipalCollectionModelAllOfEmbeddedElements
void main() {
  // final instance = PrincipalCollectionModelAllOfEmbeddedElements();

  group('test PrincipalCollectionModelAllOfEmbeddedElements', () {
    // String type
