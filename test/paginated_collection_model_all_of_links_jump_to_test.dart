...
// tests for PaginatedCollectionModelAllOfLinksJumpTo
void main() {
  // final instance = PaginatedCollectionModelAllOfLinksJumpTo();

  group('test PaginatedCollectionModelAllOfLinksJumpTo', () {
