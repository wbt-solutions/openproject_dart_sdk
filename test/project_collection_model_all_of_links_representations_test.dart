...
// tests for ProjectCollectionModelAllOfLinksRepresentations
void main() {
  // final instance = ProjectCollectionModelAllOfLinksRepresentations();

  group('test ProjectCollectionModelAllOfLinksRepresentations', () {
