...
// tests for QueryFilterInstanceSchemaModelLinksSelf
void main() {
  // final instance = QueryFilterInstanceSchemaModelLinksSelf();

  group('test QueryFilterInstanceSchemaModelLinksSelf', () {
