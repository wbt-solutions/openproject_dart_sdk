...
// tests for FileLinkWriteModelLinksOneOf1StorageUrl
void main() {
  // final instance = FileLinkWriteModelLinksOneOf1StorageUrl();

  group('test FileLinkWriteModelLinksOneOf1StorageUrl', () {
