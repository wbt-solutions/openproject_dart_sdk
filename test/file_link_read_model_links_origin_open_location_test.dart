...
// tests for FileLinkReadModelLinksOriginOpenLocation
void main() {
  // final instance = FileLinkReadModelLinksOriginOpenLocation();

  group('test FileLinkReadModelLinksOriginOpenLocation', () {
