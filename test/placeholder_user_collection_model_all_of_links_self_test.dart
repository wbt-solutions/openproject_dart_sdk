...
// tests for PlaceholderUserCollectionModelAllOfLinksSelf
void main() {
  // final instance = PlaceholderUserCollectionModelAllOfLinksSelf();

  group('test PlaceholderUserCollectionModelAllOfLinksSelf', () {
