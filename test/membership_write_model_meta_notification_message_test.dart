...
// tests for MembershipWriteModelMetaNotificationMessage
void main() {
  // final instance = MembershipWriteModelMetaNotificationMessage();

  group('test MembershipWriteModelMetaNotificationMessage', () {
