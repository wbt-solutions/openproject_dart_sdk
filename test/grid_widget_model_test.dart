...
// tests for GridWidgetModel
void main() {
  // final instance = GridWidgetModel();

  group('test GridWidgetModel', () {
    // String type
    ...
    // int startRow
    test('to test the property `startRow`', () async {
      // TODO
    });

    // The index of the ending row of the widget. The row is exclusive.
    // int endRow
    test('to test the property `endRow`', () async {
      // TODO
    });
