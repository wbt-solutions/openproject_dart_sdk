...
// tests for QueryFilterInstanceSchemaModelLinksFilter
void main() {
  // final instance = QueryFilterInstanceSchemaModelLinksFilter();

  group('test QueryFilterInstanceSchemaModelLinksFilter', () {
