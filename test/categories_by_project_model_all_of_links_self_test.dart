...
// tests for CategoriesByProjectModelAllOfLinksSelf
void main() {
  // final instance = CategoriesByProjectModelAllOfLinksSelf();

  group('test CategoriesByProjectModelAllOfLinksSelf', () {
