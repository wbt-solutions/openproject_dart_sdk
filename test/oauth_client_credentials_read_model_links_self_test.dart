...
// tests for OauthClientCredentialsReadModelLinksSelf
void main() {
  // final instance = OauthClientCredentialsReadModelLinksSelf();

  group('test OauthClientCredentialsReadModelLinksSelf', () {
