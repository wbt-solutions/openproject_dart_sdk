...
class ValuesPropertyModelTypeEnum {
  ...
  static const valuesColonColonProperty = ValuesPropertyModelTypeEnum._(r'Values::Property');
...
/// Transformation class that can [encode] an instance of [ValuesPropertyModelTypeEnum] to String,
...
class ValuesPropertyModelTypeEnumTypeTransformer {
  ...
  String encode(ValuesPropertyModelTypeEnum data) => data.value;
  ...
  ValuesPropertyModelTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'Values::Property': return ValuesPropertyModelTypeEnum.valuesColonColonProperty;
        default:
          if (!allowNull) {
