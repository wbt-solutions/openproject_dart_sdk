...
// tests for TimeEntryCollectionModelAllOfLinksSelf
void main() {
  // final instance = TimeEntryCollectionModelAllOfLinksSelf();

  group('test TimeEntryCollectionModelAllOfLinksSelf', () {
