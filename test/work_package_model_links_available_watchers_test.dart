...
// tests for WorkPackageModelLinksAvailableWatchers
void main() {
  // final instance = WorkPackageModelLinksAvailableWatchers();

  group('test WorkPackageModelLinksAvailableWatchers', () {
