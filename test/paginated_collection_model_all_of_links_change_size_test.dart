...
// tests for PaginatedCollectionModelAllOfLinksChangeSize
void main() {
  // final instance = PaginatedCollectionModelAllOfLinksChangeSize();

  group('test PaginatedCollectionModelAllOfLinksChangeSize', () {
