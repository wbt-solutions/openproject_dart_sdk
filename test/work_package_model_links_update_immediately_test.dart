...
// tests for WorkPackageModelLinksUpdateImmediately
void main() {
  // final instance = WorkPackageModelLinksUpdateImmediately();

  group('test WorkPackageModelLinksUpdateImmediately', () {
