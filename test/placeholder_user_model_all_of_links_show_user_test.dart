...
// tests for PlaceholderUserModelAllOfLinksShowUser
void main() {
  // final instance = PlaceholderUserModelAllOfLinksShowUser();

  group('test PlaceholderUserModelAllOfLinksShowUser', () {
