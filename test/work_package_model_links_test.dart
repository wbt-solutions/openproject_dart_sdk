...
// tests for WorkPackageModelLinks
void main() {
  // final instance = WorkPackageModelLinks();

  group('test WorkPackageModelLinks', () {
    ...
    // List<WorkPackageModelLinksCustomActionsInner> customActions (default value: const [])
    test('to test the property `customActions`', () async {
      // TODO
    });
    ...
    test('to test the property `unwatch`', () async {
      // TODO
    });
    ...
    // List<WorkPackageModelLinksAncestorsInner> ancestors (default value: const [])
    ...
    // List<WorkPackageModelLinksChildrenInner> children (default value: const [])
    test('to test the property `children`', () async {
      // TODO
    });

    // WorkPackageModelLinksAddFileLink addFileLink
    test('to test the property `addFileLink`', () async {
      // TODO
    });

    // WorkPackageModelLinksFileLinks fileLinks
    test('to test the property `fileLinks`', () async {
      // TODO
    });
