...
class AttachmentsApi {
  ...
  Future<Response> addAttachmentToMeetingWithHttpInfo(int id,) async {
    // ignore: prefer_const_declarations
    final path = r'/api/v3/meetings/{id}/attachments'
  ...
  /// * [int] id (required):
  ///   ID of the meeting to receive the attachment
  Future<void> addAttachmentToMeeting(int id,) async {
    final response = await addAttachmentToMeetingWithHttpInfo(id,);
  ...
  Future<Response> listAttachmentsByMeetingWithHttpInfo(int id,) async {
    // ignore: prefer_const_declarations
    final path = r'/api/v3/meetings/{id}/attachments'
      .replaceAll('{id}', id.toString());
  ...
  /// * [int] id (required):
  ///   ID of the meeting whose attachments will be listed
  Future<AttachmentsModel?> listAttachmentsByMeeting(int id,) async {
    final response = await listAttachmentsByMeetingWithHttpInfo(id,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
