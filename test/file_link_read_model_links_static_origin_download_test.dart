...
// tests for FileLinkReadModelLinksStaticOriginDownload
void main() {
  // final instance = FileLinkReadModelLinksStaticOriginDownload();

  group('test FileLinkReadModelLinksStaticOriginDownload', () {
