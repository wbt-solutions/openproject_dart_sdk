...
// tests for ProjectModelLinksCreateWorkPackageImmediately
void main() {
  // final instance = ProjectModelLinksCreateWorkPackageImmediately();

  group('test ProjectModelLinksCreateWorkPackageImmediately', () {
