...
// tests for ListAvailableParentProjectCandidatesModelAllOfLinksSelf
void main() {
  // final instance = ListAvailableParentProjectCandidatesModelAllOfLinksSelf();

  group('test ListAvailableParentProjectCandidatesModelAllOfLinksSelf', () {
