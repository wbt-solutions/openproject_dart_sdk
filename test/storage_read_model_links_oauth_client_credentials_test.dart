...
// tests for StorageReadModelLinksOauthClientCredentials
void main() {
  // final instance = StorageReadModelLinksOauthClientCredentials();

  group('test StorageReadModelLinksOauthClientCredentials', () {
