...
// tests for TimeEntryActivityModelLinksProjectsInner
void main() {
  // final instance = TimeEntryActivityModelLinksProjectsInner();

  group('test TimeEntryActivityModelLinksProjectsInner', () {
