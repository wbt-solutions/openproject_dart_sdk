...
// tests for FileLinkReadModelLinksStaticOriginOpenLocation
void main() {
  // final instance = FileLinkReadModelLinksStaticOriginOpenLocation();

  group('test FileLinkReadModelLinksStaticOriginOpenLocation', () {
