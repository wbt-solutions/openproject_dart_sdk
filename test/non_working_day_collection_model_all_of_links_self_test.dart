...
// tests for NonWorkingDayCollectionModelAllOfLinksSelf
void main() {
  // final instance = NonWorkingDayCollectionModelAllOfLinksSelf();

  group('test NonWorkingDayCollectionModelAllOfLinksSelf', () {
