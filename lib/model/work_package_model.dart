...
class WorkPackageModelTypeEnum {
  ...
  static const workPackage = WorkPackageModelTypeEnum._(r'WorkPackage');
...
/// Transformation class that can [encode] an instance of [WorkPackageModelTypeEnum] to String,
...
class WorkPackageModelTypeEnumTypeTransformer {
  ...
  String encode(WorkPackageModelTypeEnum data) => data.value;
  ...
  WorkPackageModelTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'WorkPackage': return WorkPackageModelTypeEnum.workPackage;
        default:
          if (!allowNull) {
