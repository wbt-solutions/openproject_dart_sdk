...
// tests for FileLinkCollectionReadModelAllOfLinksSelf
void main() {
  // final instance = FileLinkCollectionReadModelAllOfLinksSelf();

  group('test FileLinkCollectionReadModelAllOfLinksSelf', () {
