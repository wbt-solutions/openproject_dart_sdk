...
// tests for PlaceholderUserModelAllOfLinksUpdateImmediately
void main() {
  // final instance = PlaceholderUserModelAllOfLinksUpdateImmediately();

  group('test PlaceholderUserModelAllOfLinksUpdateImmediately', () {
