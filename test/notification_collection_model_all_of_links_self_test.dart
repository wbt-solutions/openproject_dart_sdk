...
// tests for NotificationCollectionModelAllOfLinksSelf
void main() {
  // final instance = NotificationCollectionModelAllOfLinksSelf();

  group('test NotificationCollectionModelAllOfLinksSelf', () {
