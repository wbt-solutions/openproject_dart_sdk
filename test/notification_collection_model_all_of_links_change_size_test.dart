...
// tests for NotificationCollectionModelAllOfLinksChangeSize
void main() {
  // final instance = NotificationCollectionModelAllOfLinksChangeSize();

  group('test NotificationCollectionModelAllOfLinksChangeSize', () {
