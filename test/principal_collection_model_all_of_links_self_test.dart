...
// tests for PrincipalCollectionModelAllOfLinksSelf
void main() {
  // final instance = PrincipalCollectionModelAllOfLinksSelf();

  group('test PrincipalCollectionModelAllOfLinksSelf', () {
