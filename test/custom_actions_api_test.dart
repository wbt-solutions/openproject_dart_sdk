...
void main() {
  // final instance = CustomActionsApi();
  ...
  group('tests for CustomActionsApi', () {
    ...
    //
    //Future executeCustomAction(int id, { ExecuteCustomActionRequest executeCustomActionRequest }) async
    test('test executeCustomAction', () async {
      // TODO
    });
    ...
    test('test getCustomAction', () async {
      // TODO
    });
