...
class PrioritiesApi {
  ...
  ///
  /// 
  Future<PriorityCollectionModel?> listAllPriorities() async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      return await apiClient.deserializeAsync(await _decodeBodyBytes(response), 'PriorityCollectionModel',) as PriorityCollectionModel;
