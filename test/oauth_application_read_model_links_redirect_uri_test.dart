...
// tests for OauthApplicationReadModelLinksRedirectUri
void main() {
  // final instance = OauthApplicationReadModelLinksRedirectUri();

  group('test OauthApplicationReadModelLinksRedirectUri', () {
