...
// tests for PriorityCollectionModelAllOfLinksSelfAllOfSelf
void main() {
  // final instance = PriorityCollectionModelAllOfLinksSelfAllOfSelf();

  group('test PriorityCollectionModelAllOfLinksSelfAllOfSelf', () {
