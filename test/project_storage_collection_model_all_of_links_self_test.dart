...
// tests for ProjectStorageCollectionModelAllOfLinksSelf
void main() {
  // final instance = ProjectStorageCollectionModelAllOfLinksSelf();

  group('test ProjectStorageCollectionModelAllOfLinksSelf', () {
