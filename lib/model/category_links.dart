...
class CategoryLinks {
  ...
  static CategoryLinks? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CategoryLinks[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CategoryLinks[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CategoryLinks>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CategoryLinks>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CategoryLinks.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CategoryLinks> mapFromJson(dynamic json) {
    final map = <String, CategoryLinks>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CategoryLinks.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<CategoryLinks>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CategoryLinks>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CategoryLinks.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
