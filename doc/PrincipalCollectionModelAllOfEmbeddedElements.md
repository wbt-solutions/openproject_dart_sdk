# openproject_dart_sdk.model.PrincipalCollectionModelAllOfEmbeddedElements
...
**updatedAt** | [**DateTime**](DateTime.md) | Time of the most recent change to the principal | [optional] 
...
**status** | **String** | The current activation status of the placeholder user.  # Conditions  - User has `manage_placeholder_user` permission globally | [optional] 
