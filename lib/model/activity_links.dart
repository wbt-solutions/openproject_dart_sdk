...
class ActivityLinks {
  ...
  static ActivityLinks? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ActivityLinks[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ActivityLinks[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ActivityLinks>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ActivityLinks>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ActivityLinks.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ActivityLinks> mapFromJson(dynamic json) {
    final map = <String, ActivityLinks>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ActivityLinks.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<ActivityLinks>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ActivityLinks>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ActivityLinks.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
