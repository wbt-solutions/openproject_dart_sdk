...
// tests for CustomActionModelLinksExecuteImmediately
void main() {
  // final instance = CustomActionModelLinksExecuteImmediately();

  group('test CustomActionModelLinksExecuteImmediately', () {
