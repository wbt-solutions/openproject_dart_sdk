...
// tests for MembershipReadModelLinksUpdateImmediately
void main() {
  // final instance = MembershipReadModelLinksUpdateImmediately();

  group('test MembershipReadModelLinksUpdateImmediately', () {
