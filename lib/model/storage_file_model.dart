...
class StorageFileModelTypeEnum {
  ...
  static const storageFile = StorageFileModelTypeEnum._(r'StorageFile');
...
/// Transformation class that can [encode] an instance of [StorageFileModelTypeEnum] to String,
...
class StorageFileModelTypeEnumTypeTransformer {
  ...
  String encode(StorageFileModelTypeEnum data) => data.value;
  ...
  StorageFileModelTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'StorageFile': return StorageFileModelTypeEnum.storageFile;
        default:
          if (!allowNull) {
