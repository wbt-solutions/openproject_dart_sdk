...
// tests for FileLinkReadModelLinksStaticOriginOpen
void main() {
  // final instance = FileLinkReadModelLinksStaticOriginOpen();

  group('test FileLinkReadModelLinksStaticOriginOpen', () {
