...
// tests for StorageReadModelLinksAuthorizationState
void main() {
  // final instance = StorageReadModelLinksAuthorizationState();

  group('test StorageReadModelLinksAuthorizationState', () {
