...
// tests for NotificationCollectionModelAllOfLinksJumpTo
void main() {
  // final instance = NotificationCollectionModelAllOfLinksJumpTo();

  group('test NotificationCollectionModelAllOfLinksJumpTo', () {
